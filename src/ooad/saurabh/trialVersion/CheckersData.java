    ...
    CheckersMove[] getLegalMoves(int player) {     
          ...
          for (int col = 0; col < 8; col++) {
             if (board[row][col] == player || board[row][col] == playerKing) {
                if (canJump(player, row, col, row+1, col+1, row+2, col+2)) {
                   ...
                   System.out.println("canJump 1st if : " + row +"," + col + " --> " + (row+2) + "," + (col+2));
                   System.out.println("------------------------------------------");
                }
                if (canJump(player, row, col, row-1, col+1, row-2, col+2)) {
                   moves.add(new CheckersMove(row, col, row-2, col+2));
                   System.out.println("canJump 2nd if : " + row +"," + col + " --> " + (row-2) + "," + (col+2));
                   System.out.println("------------------------------------------");
                }
                if (canJump(player, row, col, row+1, col-1, row+2, col-2)) {
                   moves.add(new CheckersMove(row, col, row+2, col-2));
                   System.out.println("canJump 3rd if : " + row +"," + col + " --> " + (row+2) + "," + (col-2));
                   System.out.println("------------------------------------------");
                }
                if (canJump(player, row, col, row-1, col-1, row-2, col-2)) {
                   moves.add(new CheckersMove(row, col, row-2, col-2));
                   System.out.println("canJump 4th if : " + row +"," + col + " --> " + (row-2) + "," + (col-2));
                   System.out.println("------------------------------------------");
                }
             }
          }
             ...
             for (int col = 0; col < 8; col++) {
                if (board[row][col] == player || board[row][col] == playerKing) {
                   if (canMove(player,row,col,row+1,col+1)) {
                      ...
                      System.out.println("canMove 1st if : " + row +"," + col + " --> " + (row+1) + "," + (col+1));
                      System.out.println("------------------------------------------");
                   }
                   if (canMove(player,row,col,row-1,col+1)) {
                      moves.add(new CheckersMove(row,col,row-1,col+1));
                      System.out.println("canMove 2nd if : " + row +"," + col + " --> " + (row-1) + "," + (col+1));
                      System.out.println("------------------------------------------");
                   }
                   if (canMove(player,row,col,row+1,col-1)) {
                      moves.add(new CheckersMove(row,col,row+1,col-1));
                      System.out.println("canMove 3rd if : " + row +"," + col + " --> " + (row+1) + "," + (col-1));
                      System.out.println("------------------------------------------");
                   }
                   if (canMove(player,row,col,row-1,col-1)) {
                      moves.add(new CheckersMove(row,col,row-1,col-1));
                      System.out.println("canMove 4th if : " + row +"," + col + " --> " + (row-1) + "," + (col-1));
                      System.out.println("------------------------------------------");
                   }
                }
             }
       ...
       if (moves.size() == 0)
          ...
          for (int i = 0; i < moves.size(); i++) {
             ...
             System.out.println("Contents of moveArray = " + moveArray[i].fromRow + "," + moveArray[i].fromCol
